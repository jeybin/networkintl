...
class HandleGatewayRiskPreAuthRejected implements ShouldQueue{

    use InteractsWithQueue, Queueable, SerializesModels;
    
    /**
     * Event name : GATEWAY_RISK_PRE_AUTH_REJECTED
     * 
     * Triggered when a payment has been rejected by 
     * the N-Genius Online pre-authorization risk rules service.
     */
